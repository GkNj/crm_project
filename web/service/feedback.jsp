		...
		<div class="connoisseur">
			<div class="conform">
				<div class="cfD" style="margin-top: 30px;margin-left: 50px">
					<form action="/serve.do?method=query3" method="post" name="fom" id="fom">
						<table width="90%">
							<tr>
					...
					<table border="1" cellspacing="0" cellpadding="0" >
						...
						<c:forEach items="${list}" var="ser">
							<tr>
								...
								<td>${ser.s_date}</td>
								<td><a href="/serve.do?method=query4&id=${ser.s_id}"><img class="operation" src="../base/img/update.png"></a>
								</td>
							</tr>
						</c:forEach>
						<%
