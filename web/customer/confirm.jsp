...
<div id="pageAll">
	<div class="pageTop">
		<div class="page">
			<img src="../base/img/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a onclick="javascript:history.back(-1);">客户流失管理</a>&nbsp;-</span>&nbsp;确认流失
		</div>
	</div>
				...
				<div class="cfD" style="margin-top: 30px;margin-left: 50px">
					<table width="90%">
						...
						<tr>
							...
							<td width="30%" colspan="3" class="tdColor" style="color: black">${lost.l_measure}</td>
						</tr>
						<tr>
							<td width="100px" class="tdColor tdC" style="background-color: #47a4e1;color: black">流失原因</td>
							<td colspan="3" width="30%" class="tdColor" style="color: black"><textarea name="reason" style="width: 350px;height: 80px" name="reason"></textarea></td>
						</tr>
						</c:forEach>
					</table>
				</div>
